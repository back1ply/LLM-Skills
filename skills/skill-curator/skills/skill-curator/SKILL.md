...
|----------|-----------------|---------------|
| **Gemini CLI** | `.gemini/skills/`, `~/.gemini/skills/` | `SKILL.md` + JSON |
...
**Gemini CLI:** Scan `.gemini/skills/**/SKILL.md` and `~/.gemini/skills/**/SKILL.md`, check MCP server configurations, parse each SKILL.md frontmatter.
